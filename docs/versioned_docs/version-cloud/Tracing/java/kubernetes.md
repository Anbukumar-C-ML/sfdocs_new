...
2. Make sure that the project and application are created in the SnappyFlow server. [Click here](/docs/RUM/agent_installation/others#create-a-project-in-snappyflow-portal) to create a project and an application in SnappyFlow. 
