...
const AGENTS = [
	
	{
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/postgres/overview'
	},
	{
		'src': '/img/java.svg',
		'label': 'Java',
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/java/overview'
	}, 
	{
		'src': '/img/golang.svg',
		'label': 'Go',
		...
		'category': ['Profiling'],
		'link': '/docs/selfhosted-turbo/integrations/go/profiler'
	},
	{
		'src': '/img/mongodb.svg',
		'label': 'MongoDB',
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/integrations/mongodb'
	...
	},
	{
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/plugin/oracleASH'
	...
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/integrations/haproxy'
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/integrations/activemq'
	},
	{
	...
	},
	{
		...
		'link': '/docs/selfhosted-turbo/Integrations/plugin/blob'
	},
	{
		'src': '/img/aws_rds.svg',
		'label': 'AWS RDS',
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/plugin/rds'
	}, 
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/integrations/zookeeper'
	},
	{
		...
		'category': ['Platform'],
		'link': '/docs/selfhosted-turbo/Integrations/kubernetes/overview'
	},
	{
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/clickhouse_kubernetes'
	}, 
	{
		'src': '/img/mysql.svg',
		'label': 'MySQL',
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/mysql/overview'
	}, 
	{
		'src': '/img/mssql.svg',
		'label': 'MSSQL',
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/mssql_windows'
	}, 
	{
		'src': '/img/nginx.svg',
		'label': 'Nginx',
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/nginx/overview'
	}, 
	{
		'src':'/img/tomcat.svg',
		'label':'Tomcat',
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/integrations/tomcat/tomcat_windows'
	},
	{
		...
		'link': '/docs/selfhosted-turbo/alerts_notifications/pager_duty'
	},
	{
		'src': '/img/apache.svg',
		'label': 'Apache',
		'overText': 'Postgres Infrastructure platform is built for enterprises',
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/apache/overview'
	}, 
	{
		...
		'category': ['Cloud Services'],
		'link': '/docs/selfhosted-turbo/Integrations/elasticache/elasticache'
	}, 
	{
		...
		'category': ['Cloud Services'],
		'link': '/docs/selfhosted-turbo/Integrations/elb/elb_rds'
	}, 
	{
		'src': '/img/redis.svg',
		'label': 'Redis',
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/integrations/redis/overview'
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/rabbitmqinstance'
	},
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/tripwire'
	}, 
	{
		'src': '/img/stack.svg',
		'label': 'Slack',
		...
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/alerts_notifications/slack'
	}, 
	{
		...
		'link': '/docs/selfhosted-turbo/Integrations/os/windows/sfagent_windows'
	}, 
	{
	...
	}, 
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/integrations/statsd/custom_monitoring'
	},  
	{
		...
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/Alerts_notifications/Notifications/Create_Notification_Channel/email'
	},
	{
		...
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/Alerts_notifications/Notifications/Create_Notification_Channel/opsgenie'
	},
	{
		...
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/Alerts_notifications/Notifications/Create_Notification_Channel/teams'
	},
	{
		...
		'overText': 'Teams Notification Channel',
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/Alerts_notifications/Notifications/Create_Notification_Channel/zenduty'
	},
	{
		...
		'overText': 'Teams Notification Channel',
		'category': ['Alerts & Notifications'],
		'link': '/docs/selfhosted-turbo/Alerts_notifications/Notifications/Create_Notification_Channel/webhook'
	},
	{
		...
		'category': ['Databases'],
		'link': '/docs/selfhosted-turbo/Integrations/plugin/azuredb'
	},
	{
		'src': '/img/java.svg',
		'label': 'Java Profiler',
		...
		'category': ['Profiling'],
		'link': '/docs/selfhosted-turbo/Tracing/python/overview'
	},
	{
		...
		'overText': 'MySQL Infrastructure platform is built for enterprises',
		'category': ['Operating System'],
		'link': '/docs/selfhosted-turbo/Integrations/os/linux/overview'
	},
	{
	...
	},
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Tracing/aspdotnetcore'
	},
	{
		...
		'overText': 'C# framework',
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Tracing/dotnetframework'
	},
	{
	...
	},
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/RUM/agent_installation/angular'
	},
	{
		...
		'overText': 'for Real user monitoring',
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/RUM/agent_installation/react'
	},
	{
		...
		'overText': 'for Real user monitoring',
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/RUM/agent_installation/nextjs'
	},
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Tracing/ruby/overview'
	},
	{
		...
		'category': ['App Tier'],
		'link': '/docs/selfhosted-turbo/Tracing/csharp'
	},
	{
		'src': '/img/golang.svg',
		'label': 'Go',
	...
	},
	{
		...
		'link': '/docs/selfhosted-turbo/Integrations/plugin/aws'
	},
	{
	...
	},
	{
		...
		'category': ['Infrastructure'],
		'link': '/docs/selfhosted-turbo/Integrations/plugin/vcenter'
	},
	{
	...
	},
	{
		...
		'category': ['Cloud Services'],
		'link': '/docs/selfhosted-turbo/Integrations/cloudwatch'
	},
	{
	...
	},
	{
		...
		'category': ['Database'],
		'link': '/docs/selfhosted-turbo/Integrations/docdb'
	},
	{
	...
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/pgBouncer/pgBouncer_on_instance'
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/jboss'
	},
	{
		...
		'category': ['Web Tier'],
		'link': '/docs/selfhosted-turbo/Integrations/plugin/azurelog'
	},
