...
Skip functions are used in [Feature Extraction](/docs/selfhosted-turbo/Log_management/feature_extraction) and allow moving the pointer/imaginary cursor to a position of interest in the log line.
