...
Make sure the project and application is created in the SnappyFlow Server. [Click Here](/docs/selfhosted-turbo/RUM/agent_installation/others#create-a-project-in-snappyflow-portal) to know how to create the project and application in SnappyFlow.
