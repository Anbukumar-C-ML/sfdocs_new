...
**[Instances](/docs/selfhosted-turbo/Tracing/python/python_on_instance)** | **[Kubernetes](/docs/selfhosted-turbo/Tracing/python/python_in_kubernetes)** | **[ECS](/docs/selfhosted-turbo/Tracing/python/python_in_ECS)** | **[Docker](/docs/selfhosted-turbo/Tracing/python/python_in_docker)** |**[AWS Lambda](/docs/selfhosted-turbo/Tracing/python/aws_lamda)**
