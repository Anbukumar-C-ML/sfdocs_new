...
- Install Java - JDK 11
- [Install sfAgent on Linux](/docs/sidebar-sf-selfhosted-turbo/Integrations/os/linux/sfagent_linux)
...
- Reference for installing **sfAgent** : [Click here](/docs/sidebar-sf-selfhosted-turbo/Integrations/os/linux/sfagent_linux)
