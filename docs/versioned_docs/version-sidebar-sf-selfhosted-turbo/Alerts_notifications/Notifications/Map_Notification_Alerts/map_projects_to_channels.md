...
9. For channels like Zenduty, PagerDuty, OpsGenie, etc... follow the below steps:
   ...
   You have successfully linked a notification channel to your project. The next step is to map the alerts from an application [Click here](/docs/sidebar-sf-selfhosted-turbo/Alerts_notifications/Notifications/Map_Notification_Alerts/alert_mapping).
