...
Docker running on linux can be monitored using Snappyflow sfagent. Refer the [link](/docs/selfhosted-lite/Integrations/os/linux/sfagent_linux) for installation of sfagent.
