...
Install [sfAgent](/docs/sidebar-snappyflow-saas/Quick_Start/getting_started#sfagent)  to start monitoring MySQL database running on windows using MySQL plugin.
