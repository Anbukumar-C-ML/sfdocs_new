...
##### [Monitor a Linux instance](/docs/sidebar-snappyflow-saas/integrations/os/linux/linux_os)

##### [Monitor a Kubernetes Cluster](/docs/sidebar-snappyflow-saas/integrations/kubernetes/kubernetes_monitoring_with_sfPod)

##### [Monitor a Windows instance](/docs/sidebar-snappyflow-saas/integrations/os/windows/sfagent_windows)

##### [Trace an application](/docs/sidebar-snappyflow-saas/Tracing/overview)